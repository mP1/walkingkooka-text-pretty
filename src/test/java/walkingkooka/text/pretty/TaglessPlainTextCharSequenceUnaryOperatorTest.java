...
public final class TaglessPlainTextCharSequenceUnaryOperatorTest implements FunctionTesting<TaglessPlainTextCharSequenceUnaryOperator, CharSequence, CharSequence>,
        ToStringTesting<TaglessPlainTextCharSequenceUnaryOperator> {
    ...
    private void applyAndCheck2(final CharSequence chars,
        ...
        assertEquals(expected.toString(), TaglessPlainTextCharSequenceUnaryOperator.INSTANCE.apply(chars).toString());
    }

    @Test
    public void testToString() {
        this.toStringAndCheck(TaglessPlainTextCharSequenceUnaryOperator.INSTANCE, "TaglessPlainText");
    }

    @Override
    public TaglessPlainTextCharSequenceUnaryOperator createFunction() {
        return TaglessPlainTextCharSequenceUnaryOperator.INSTANCE;
    }

    @Override
    public Class<TaglessPlainTextCharSequenceUnaryOperator> type() {
        return TaglessPlainTextCharSequenceUnaryOperator.class;
    }
