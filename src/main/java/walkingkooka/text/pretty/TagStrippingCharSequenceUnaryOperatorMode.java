 ...
 */
enum TagStrippingCharSequenceUnaryOperatorMode {
    ...
    abstract TagStrippingCharSequenceUnaryOperatorMode handle(final char c,
                                                              final StringBuilder buffer);

    final TagStrippingCharSequenceUnaryOperatorMode handleInstead(final char c,
                                                                  final StringBuilder buffer,
                                                                  final String instead) {
        final TagStrippingCharSequenceUnaryOperatorMode mode;
